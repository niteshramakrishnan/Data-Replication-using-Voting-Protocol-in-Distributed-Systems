...
public class Server1 {
  ...
  public static void main(String[] args) throws Exception {
    try{
      ...
      ServerSocket server=new ServerSocket(9991);      // dc01.utdallas.edu 
...
class ServerClientThread extends Thread {
    ...
    String server_to_client_msg = Server1.server_no + ",Server Acknowledgement";
    ...
    public void run(){
        ...
        while(inStream.available() >0 )
      {
        ...
        if(msg_no == 200)
        {
          System.out.println(">> Server 1 recieves: "+ "Server " + from_client + " request with message id:" + msg_no);
           
        }
        else if(msg_no == 100)
        {
          System.out.println(">> Server 1 recieves: "+ "Client " + from_client + " request with message id:" + msg_no);
        }     
        
        String server_msg = "200,"+ Server1.server_no + ",Server Request,"+hash1+","+hash2+","+hash3+","+"Vote Request";
        ...
        if(msg_no == 100)
        {
          Server1.if_msg_recieved = true;
          
          if(Server1.server_no == hash1 + 1)
          {
            try
            {
        ...
        else if(msg_no == 200)
        {
          ...
          if(Server1.if_msg_recieved)
          {
            //System.out.println(Server1.if_msg_recieved);
          ...
          else 
          {
            ...
            outStream.writeUTF(Server1.server_no+",No Acknowledgement");
            outStream.flush();
          }
